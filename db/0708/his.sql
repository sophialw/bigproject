...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', '门诊病历首页', 'glyphicon glyphicon-book', '/his01/mz/list.do', '0');
INSERT INTO `menu` VALUES ('2', '用户管理', 'glyphicon glyphicon-user', '/his01/user/list.do', '0');
INSERT INTO `menu` VALUES ('3', '科室管理', 'glyphicon glyphicon-user', '/his01/dept/list.do', '0');
INSERT INTO `menu` VALUES ('4', '角色管理', 'glyphicon glyphicon-user', '/his01/role/list.do', '0');
