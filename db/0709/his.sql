...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', '门诊病历首页', 'glyphicon glyphicon-book', '/his01/mz/list.do', '0', null);
INSERT INTO `menu` VALUES ('2', '用户管理', 'glyphicon glyphicon-user', '/his01/user/list.do', '0', '10');
INSERT INTO `menu` VALUES ('3', '科室管理', 'glyphicon glyphicon-user', '/his01/dept/list.do', '0', '11');
INSERT INTO `menu` VALUES ('4', '角色管理', 'glyphicon glyphicon-user', '/his01/role/list.do', '0', '98');
INSERT INTO `menu` VALUES ('5', '权限管理', 'glyphicon glyphicon-user', '/his01/menu/list.do', '0', '99');
INSERT INTO `menu` VALUES ('6', '排班管理', 'glyphicon glyphicon-user', '/his01/menu/list.do', '0', '12');
INSERT INTO `menu` VALUES ('7', '药品管理', 'glyphicon glyphicon-tint', '/pill/list.do', '0', '31');
INSERT INTO `menu` VALUES ('8', '挂号', 'glyphicon glyphicon-th', '/gh/gh.do', '0', '14');
...
INSERT INTO `role_menu` VALUES ('11', '1', '2', '0');
INSERT INTO `role_menu` VALUES ('12', '1', '6', '0');
INSERT INTO `role_menu` VALUES ('13', '1', '8', '0');
